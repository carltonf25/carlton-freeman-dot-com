...
export { apply, config, createAnimatedComponent as animated, createAnimatedComponent as a, interpolate$1 as interpolate, Globals, useSpring, useTrail, useTransition, useChain, useSprings, Interpolation };
